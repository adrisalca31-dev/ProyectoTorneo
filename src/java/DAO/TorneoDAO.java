...
public class TorneoDAO {
     ...
     *
     * Este método se utiliza para mostrar
     * el estado actual del torneo.
     */
    public Torneo obtenerTorneoPorId(int idTorneo) {
        ...
        try (
            ...
            System.out.println(
                    "Error al obtener el torneo por ID"
            );
    ...
    public boolean actualizarCampeon(
            int idTorneo,
            int idCampeon
    ) {
        ...
        try (
            ...
            System.out.println(
                    "Error al actualizar el campeón"
            );
