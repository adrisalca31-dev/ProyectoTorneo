        ...
        <div class="container mt-4 flex-grow-1">
            ...
            <div class="mb-4">
                ...
                <p class="text-muted">
                    ...
                    Consulta aquí los resultados y el estado actual del torneo.
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text small text-muted">
                                ...
                                Consulta la lista completa de equipos inscritos
                                y aprobados.
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text small text-muted">
                                ...
                                Visualiza las llaves, enfrentamientos
                                y el avance por rondas.
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text small text-muted">
                                ...
                                Revisa los resultados finales de cada partido disputado.
                    ...
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text small text-muted">
                                ...
                                Consulta la fase actual y equipos clasificados.

                            </p>

                            <a href="<%= request.getContextPath() %>/ResultadoServlet?accion=estado&idTorneo=1"
